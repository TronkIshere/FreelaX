...
public class BofaPayoutClient {
    ...
    public Map<String, Object> sendPayout(String receiverEmail, BigDecimal amountUsd, String senderBatchId) {
        ...
        if (response.getBody() == null) {
            throw new ApplicationException(ErrorCode.BOFA_PAYOUT_FAILED, senderBatchId);
        }
    ...
    private String fetchAccessToken() {
        ...
        if (response.getBody() == null || response.getBody().get("access_token") == null) {
            throw new ApplicationException(ErrorCode.BOFA_PAYOUT_FAILED, "oauth");
        }
