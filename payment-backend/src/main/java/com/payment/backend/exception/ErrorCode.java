...
public enum ErrorCode {
    ...
    PAYEE_NOT_FOUND(3000, "Không tìm thấy hồ sơ nhận tiền BofA: %s", HttpStatus.NOT_FOUND),
    ...
    BOFA_ORDER_FAILED(3006, "Giao dịch BofA thất bại: %s", HttpStatus.BAD_GATEWAY),
    PAYEE_NOT_ACTIVE(3007, "Hồ sơ nhận tiền BofA chưa được kích hoạt: %s", HttpStatus.CONFLICT),
